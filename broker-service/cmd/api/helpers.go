...
func (a *AppConfig) ReadJsonBody(w http.ResponseWriter, r *http.Request, item interface{}) error {
...
func (a *AppConfig) WriteJsonBody(w http.ResponseWriter, status int, item interface{}, header ...http.Header) error {
...
func (a *AppConfig) ErrorJson(w http.ResponseWriter, errMsg error, status ...int) error {
